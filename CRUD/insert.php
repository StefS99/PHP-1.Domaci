...
if(isset($_POST['nameSend']) && 
   ...
   isset($_POST['cenaSend'])){ //Proveravamo POST zahtev za slanje za svaki
    ...
    $sql = "INSERT INTO crud(naziv, marka, prodavac, cena) VALUES('$nameSend', '$markeSend', '$prodavacSend', '$cenaSend')"; //Svaka vrednost će se uneti istim redom unetim za kolone u tableli //Svaki unos u tabelu će biti jedinstven za svakog korisnika //crud je naziv naše tabele //piše u vrhu phpmyadmina
