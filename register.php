  ...
  <div class="card m-auto">
    ...
    <div class="card-body">
      <form>
        ...
        <div class="form-group col-12">
          <label for="cpassword" class="form-label">Potvrda lozinke</label>
        ...
        <div class="row">
          <div class="col-md-6">
            Imate nalog? <a href="../1.PHP-domaci/login.php" style="text-decoration: none;"><span class="text">Prijavite se</span></a>
          </div>
        </div>
      </form>
    </div>
